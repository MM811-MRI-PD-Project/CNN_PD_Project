...
# Dataset path 
train_path = '/home/luchen/mm811/2d_Image_CNN/Test_Train_images/GM/train/'
test_path = '/home/luchen/mm811/2d_Image_CNN/Test_Train_images/GM/test/'
...
def optimize(num_iterations):
    ...
    for i in range(total_iterations,
        ...
        feed_dict_validate = {x: x_valid_batch,
                              y_true: y_valid_batch, is_training: False,keep_prob: 1.0}
...
def print_validation_accuracy(show_example_errors=False,
    ...
    while i < num_test:
        ...
        feed_dict = {x: images,
                     y_true: labels, is_training: False, keep_prob: 1.0}
...
y1 = acc_dict['train']
y2 = acc_dict['val']
y3 = acc_dict['train_loss']
y4 = acc_dict['val_loss']
fig = plt.figure(1)
plt.plot(x, y1)
plt.plot(x, y2)
